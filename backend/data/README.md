...
Live mode creates `knyc_forecast_history.json` in this folder.
...
The local file is ignored by git because it is runtime data. No sample or invented rows are used for calibration.
